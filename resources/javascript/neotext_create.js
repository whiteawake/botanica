(function() {
	...
	MESSAGES.push({
		delay: 1200,
		text: "Drop tables if they exist..."
	});

	MESSAGES.push({
		delay: 2200,
		text: "create Plants table.."
	});

	MESSAGES.push({
		delay: 3600,
		text: "create Locations table..."
	});
	...
	scramble = function(element, text, options) {
		...
		order = (function() {
			_results = [];
			for (var _i = 0; 0 <= textLength ? _i < textLength : _i > textLength; 0 <= textLength ? _i++ : _i--) {
				_results.push(_i);
			}
			return _results;
