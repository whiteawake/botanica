...
binom = form.getvalue('binom')
location = form.getvalue('location')
family = form.getvalue('family')
comment = form.getvalue('comment')

f = open('plants.txt', 'a')
f.write(str(name + ' | ' + binom +  ' | ' + location + ' | ' + family + ' | ' + comment + '\n'))
f.close()
print("""
	<!DOCTYPE html>
	<html>
	...
	<body>
				...
				<ul>
					...
					<li class="drop">
            			...
            			<div class="dropdownContain">
							<div class="dropOut">
								<ul>
									<li><a href="first_50.py">First 10</a></li>
								</ul>
								<ul>
		...
		<h2 class="descript"> 
		Plant successfully added to database:</h2><font color="white"><p><br />"""
		+ 'Common name: ' + name + '<br />' + 'Scientific name: ' + binom + '<br />' + 'Comment: ' + comment +
		"""
		</p></font>
		</div>
	...
	"""),
print('<meta http-equiv="refresh" content="5; url=/botanica/database.py">')